    ...
    <section id="product" className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo}>
            ...
            <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
                <img src={apple} atl="apple_store" className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer'/>
                <img src={google} atl="google_play" className='w-[128px] h-[42px] object-contain cursor-pointer'/>
            </div>
        </div>
    </section>
  )
